...
<?php include(__DIR__ . '/../includes/header.php'); ?>
        ...
        <section id="section-hero-sports" class="section-dark text-light jarallax relative mh-800">
            <img src="/images/background/14.png" class="jarallax-img" alt="">
                ...
                <div class="container wow scaleIn" data-wow-duration="3s">
                    <div class="row">
                        <div class="col-lg-12 text-center">
                            <h1 class="fs-120 text-uppercase id-color fw-bold mb-4 lh-1" style="color: var(--primary-color) !important;">CORPORATE EVENTS</h1>
                            <div class="fs-24 text-white mb-5 mx-auto opacity-75" style="max-width: 850px;">Elevating corporate gatherings to unparalleled heights, we specialize in curating flawlessly executed events that seamlessly blend professionalism with business goals.</div>
                            
                            <!-- Dropdown -->
                            <div class="dropdown-v2 d-inline-block mt-3 position-relative">
                                <button class="btn border border-white border-opacity-20 px-4 py-3 d-flex justify-content-between align-items-center" type="button" id="corporateDropdown" data-bs-toggle="dropdown" aria-expanded="false" data-bs-display="static" style="width: 320px; background: rgba(0,0,0,0.8); backdrop-filter: blur(10px); z-index: 10; border-radius: 0;">
                                    <span class="fs-14 fw-bold text-white ls-2 uppercase">TYPE OF EVENT</span>
                                    <i class="fa fa-chevron-down text-white-50 fs-10 ms-2"></i>
                                </button>
                                <ul class="dropdown-menu dropdown-menu-dark w-100 mt-0 rounded-0 custom-scrollbar" aria-labelledby="corporateDropdown" style="background: rgba(0,0,0,0.95); border: 1px solid rgba(255,255,255,0.1); position: absolute; top: 100%; left: 0; padding: 0; max-height: 250px; overflow-y: auto;">
                                    <li><a class="dropdown-item py-3 px-4 fw-bold text-white fs-13 ls-1 hover-bg-color border-bottom border-white border-opacity-10" href="#">ANNUAL DAYS</a></li>
                                    <li><a class="dropdown-item py-3 px-4 fw-bold text-white fs-13 ls-1 hover-bg-color border-bottom border-white border-opacity-10" href="#">CONFERENCES</a></li>
                                    <li><a class="dropdown-item py-3 px-4 fw-bold text-white fs-13 ls-1 hover-bg-color border-bottom border-white border-opacity-10" href="#">EXHIBITIONS</a></li>
                                    <li><a class="dropdown-item py-3 px-4 fw-bold text-white fs-13 ls-1 hover-bg-color border-bottom border-white border-opacity-10" href="#">FAMILY DAYS</a></li>
                                    <li><a class="dropdown-item py-3 px-4 fw-bold text-white fs-13 ls-1 hover-bg-color border-bottom border-white border-opacity-10" href="#">GALA DINNERS</a></li>
                                    <li><a class="dropdown-item py-3 px-4 fw-bold text-white fs-13 ls-1 hover-bg-color border-bottom border-white border-opacity-10" href="#">LAUNCH EVENTS</a></li>
                        ...
                        <div class="wow fadeInUp mb-4" data-wow-delay=".4s">
                            <div class="event-item-bg d-flex flex-column flex-lg-row align-items-center w-100">
                                ...
                                <div class="col-lg-5 mb-4 mb-lg-0 text-center text-lg-start">
                                    <h3 class="text-white mb-3 fs-24 fw-bold">Sparkle & Shine<br>Events</h3>
                                    <p class="text-white-op-7 mb-0 fs-15 lh-base">
                                        A personal portfolio is a curated collection of<br>an individual's professional work
                                    </p>
                                </div>
                                ...
                                <div class="col-lg-3 mb-4 mb-lg-0 text-center">
                                    <img src="/images/news/s3.webp" class="event-card-img" alt="">
                                </div>
                                
                                <div class="col-lg-2 mb-4 mb-lg-0 text-start">
