...
<?php include(__DIR__ . '/../includes/header.php'); ?>
        ...
        <section id="section-hero-sports" class="section-dark text-light jarallax relative mh-800">
            <img src="/images/background/15.png" class="jarallax-img" alt="">
                ...
                <div class="container wow scaleIn" data-wow-duration="3s">
                    <div class="row">
                        <div class="col-lg-12 text-center">
                            <h1 class="fs-120 text-uppercase id-color fw-bold mb-4 lh-1" style="color: var(--primary-color) !important;">SPECIAL EVENTS</h1>
                            <div class="fs-24 text-white mb-5 mx-auto opacity-75" style="max-width: 850px;">Orchestrating versatile mastery that spans weddings, government affairs, festive celebrations, and any one off event where we transform visions into unforgettable realities.</div>
                            
                            <!-- Dropdown -->
                            <div class="dropdown-v2 d-inline-block mt-3 position-relative">
                                <button class="btn border border-white border-opacity-20 px-4 py-3 d-flex justify-content-between align-items-center" type="button" id="specialDropdown" data-bs-toggle="dropdown" aria-expanded="false" data-bs-display="static" style="width: 320px; background: rgba(0,0,0,0.8); backdrop-filter: blur(10px); z-index: 10; border-radius: 0;">
                                ...
                                <ul class="dropdown-menu dropdown-menu-dark w-100 mt-0 rounded-0 custom-scrollbar" aria-labelledby="specialDropdown" style="background: rgba(0,0,0,0.95); border: 1px solid rgba(255,255,255,0.1); position: absolute; top: 100%; left: 0; padding: 0; max-height: 250px; overflow-y: auto;">
                                    <li><a class="dropdown-item py-3 px-4 fw-bold text-white fs-13 ls-1 hover-bg-color border-bottom border-white border-opacity-10" href="#">WEDDINGS</a></li>
                                    <li><a class="dropdown-item py-3 px-4 fw-bold text-white fs-13 ls-1 hover-bg-color border-bottom border-white border-opacity-10" href="#">CELEBRATIONS</a></li>
                                    <li><a class="dropdown-item py-3 px-4 fw-bold text-white fs-13 ls-1 hover-bg-color border-bottom border-white border-opacity-10" href="#">LIGHTING</a></li>
                                    <li><a class="dropdown-item py-3 px-4 fw-bold text-white fs-13 ls-1 hover-bg-color border-bottom border-white border-opacity-10" href="#">BRAND IP'S</a></li>
                                    <li><a class="dropdown-item py-3 px-4 fw-bold text-white fs-13 ls-1 hover-bg-color border-bottom border-white border-opacity-10" href="#">FESTIVALS</a></li>
