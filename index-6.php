        ...
        <section id="section-hero" class="section-dark text-light pt-80 pb-0 jarallax relative overflow-hidden jarallax">
            ...
            <div class="container">
              <div class="row g-4 gx-5 align-items-center">
                <div class="col-lg-6">
                  <div class="relative">
                    <img src="images/misc/c2.webp" class="w-100 wow fadeInUp" data-wow-delay=".3s" alt="">
                  </div>                        
                </div>
                <div class="col-lg-6">
                  <div class="subtitle s2 mb-3 wow fadeInUp" data-wow-delay=".0s">Welcome to Aivent</div>
                  <h1 class="wow fadeInUp" data-wow-delay=".2s">Empowering the Future with Artificial Intelligence</h1>
                  <p class="col-lg-10 wow fadeInUp" data-wow-delay=".4s">
                    Join global innovators, researchers, and industry leaders at Aivent — a premier conference exploring real-world applications of AI. Discover cutting-edge technologies, gain insights from experts, and shape the next wave of intelligent solutions.
                  </p>
                  <a class="btn-main fx-slide mb10 mb-3 wow fadeInUp" data-wow-delay=".6s" href="tickets.php"><span>Get Ticket</span></a>
                </div>
              </div>
            </div>
                        ...
                        <div class="row g-4">
                            <div class="col-6">
                                <div class="relative overflow-hidden rounded-1 wow scale-in-mask mb-4">
                                    <img src="images/misc/s1.webp" class="img-fluid" alt="">
                        ...
                        <div class="owl-carousel owl-theme owl-3-dots wow mask-right">
                            ...
                            <div class="item">
                                ...
                                <div class="relative overflow-hidden">
                                    ...
                                    <a class="btn-main fx-slide w-100" href="tickets.php"><span>Buy Ticket</span></a>
