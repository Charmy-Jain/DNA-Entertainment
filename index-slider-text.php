                    ...
                    <div class="swiper-slide">
                        <div class="abs abs-centered z-2 w-100">
                            <div class="container" data-wow-duration="1s">
                                <div class="row">
                                    <div class="col-lg-7">
                                        <div class="subtitle">AI Summit 2026</div>
                                        <h1 class="mb-4 uppercase">Unleashing Human Potential Through AI</h1>
                            ...
                            <div class="container" data-wow-duration="1s">
                                <div class="row justify-content-center">
                                    <div class="col-lg-12 text-center">
                                        <div class="subtitle">Next Intelligence</div>
                                        <h1 class="mb-4 uppercase fs-72">Empowering Tomorrow, Today.</h1>
